...
docker run -d -v /etc/localtime:/etc/localtime:ro -v /var/local/java-log/account:/var/local/java-log/account --memory 700m --restart=always --name car-account-dev --network host car-account-dev
exit
remotessh
